...
void solve(){
    ...
    cout<<"Average running time of Quick Sort : " << 1.0*(tot_time_1/number_of_iteration)/CLOCKS_PER_SEC<<endl;
    cout<<"Average no. of comparisons during Quick Sort : "<<((double)tot_comps/(number_of_iteration))<<endl;;
    cout<<"Average value of double sort time by Quick Sort : "<<((tot_time_1+tot_time_2)/number_of_iteration)/CLOCKS_PER_SEC<<endl;
}
